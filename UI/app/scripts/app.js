...
.config(function($stateProvider, $urlRouterProvider) {
	...
	.state('Analyse_Java_Class', {
        url: '/Analyser/Analyse_Java_Class',
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/Analyser/Analyse_Java_Class.html?v='+window.app_version,
        controller: 'Analyse_Java_Class'
	 })		 
